 ...
 * Time: 19:00
 */
namespace Jungle\Activetype {

	/**
	 * Class TypeManager
	 * @package Jungle\RegExp
	 */
	class TypeManager implements TypeAwareInterface{
		...
		/**
		 * @param TypeManager|null $parent
		 * @param bool $overlap
		 * @return $this
		 */
		public function setParent(TypeManager $parent = null, $overlap = false){
			$this->parent = $parent;
		...
		public static function validate($value, $type, array $options = null){
			...
			throw new TypeException('RegExp.Type "'.$type.'" not found in manager!');
		}
		...
		public static function setDefault(TypeManager $registry){
